...
abstract class $CartStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({CartStatus status, List<CartItem> items, String? error});
}
...
class _$CartStateImpl extends _CartState {
  ...
  @override
  String toString() {
    return 'CartState(status: $status, items: $items, error: $error)';
  }
...
abstract class _CartState extends CartState {
  const factory _CartState(
      ...
      required final List<CartItem> items,
      required final String? error}) = _$CartStateImpl;
